     ...
     <tr> 
      <td class="st-br" valign="top"> 
       <table cellpadding="0" cellspacing="0" class="es-header" align="center"> 
         <tr> 
          <td align="center" style="background-image: url(http://cinextreme.co/assets/images/20841560930387653.jpg); background-color: transparent; background-position: center bottom; background-repeat: no-repeat;" bgcolor="transparent"> 
           <div> 
                  ...
                  <tr> 
                   <td width="560" align="center" valign="top"> 
                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> 
                      <tr> 
                       <td align="center" style="font-size: 0px;"><a target="_blank" href="https://cinextreme.co"><img src="http://cinextreme.co/assets/images/81081586713151268.png" alt style="display: block; width: 276px; height: 113px;" width="276" height="109"></img></a></td> 
                      </tr> 
                      <tr> 
         ...
         <tr> 
          <td align="center" bgcolor="transparent" style="background-color: transparent;"> 
           <table bgcolor="transparent" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600" style="background-color: transparent;"> 
             <tr> 
              <td class="es-p30t es-p15b es-p30r es-p30l" align="left" style="border-radius: 10px 10px 0px 0px; background-color: #ffffff;" bgcolor="#ffffff"> 
               <table cellpadding="0" cellspacing="0" width="100%"> 
                 <tr> 
                  <td width="540" align="center" valign="top"> 
                   <table cellpadding="0" cellspacing="0" width="100%" style="background-position: left bottom;" role="presentation"> 
                     <tr> 
                      <td align="center"><h1>Restablecimiento de contraseña</h1></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
             ...
             <tr> 
              <td class="es-p5t es-p5b es-p30r es-p30l" align="left" style="border-radius: 0px 0px 10px 10px; background-position: left top; background-color: #ffffff;"> 
               <table cellpadding="0" cellspacing="0" width="100%"> 
                 <tr> 
                  <td width="540" align="center" valign="top"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> 
                     <tr> 
                      <td align="left"> 
                       <ul> 
                        <li>Haz click en el siguiente enlace para restablecer tu contraseña: "enlace"</li> 
                       </ul></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
       ...
       <table cellpadding="0" cellspacing="0" class="es-footer" align="center"> 
         <tr> 
          <td align="center" style="background-color: #090909;" bgcolor="#090909"> 
           <table bgcolor="#0e0d0d" class="es-footer-body" align="center" cellpadding="0" cellspacing="0" width="600" style="background-color: #0e0d0d;"> 
             <tr> 
              <td class="es-p35t es-p10b es-p40r es-p40l" style="border-radius: 0px 0px 10px 10px; background-color: #0b0a0a;" align="left" bgcolor="#0b0a0a"> 
               <table cellspacing="0" cellpadding="0" width="100%"> 
                 <tr> 
                  <td class="es-m-p0r" width="520" align="center"> 
               ...
               <table cellpadding="0" cellspacing="0" width="100%"> 
                 <tr> 
                  <td width="600" align="center" valign="top"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation"> 
                     <tr> 
                      <td align="center" height="8" bgcolor="#0b0a0a"></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
